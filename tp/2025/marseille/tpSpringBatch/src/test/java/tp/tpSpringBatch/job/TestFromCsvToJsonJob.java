...
import tp.tpSpringBatch.reader.MyCsvFileProductReaderConfig;
import tp.tpSpringBatch.writer.MyJsonFileProductWriterConfig;
...
public class TestFromCsvToJsonJob extends AbstractBasicActiveTestJob {
	...
	public JobParametersBuilder initJobParametersWithBuilder(JobParametersBuilder jobParametersBuilder) {
		...
		.addString("inputFilePath", "data/input/csv/products.csv")
        .addString("outputFilePath", "data/output/json/products.json");//used by productCsvFileReader
	}
